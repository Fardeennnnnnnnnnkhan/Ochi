...
function Footer() {
  return (
    <div data-scroll data-scroll-speed='-0.3'  className='w-full flex h-screen bg-[#CDEA68] p-20'>
      <div className="w-1/2 h-full flex justify-between flex-col ">
      <div className="heading ">

      <h1 className='text-7xl leading-none tracking-tighter font-bold'>EYE- </h1>
      <h1 className='text-7xl leading-none tracking-tighter font-bold'>OPENING </h1>
      ...
      <div className="w-1/2 ">
      <h1 className='text-7xl leading-none tracking-tighter font-bold'>PRESENTATIONS </h1>

       <div className="footer flex justify-between flex-wrap">
       <div className="below w-full  flex flex-col gap-4 mt-4">
        <h5>S:</h5>
       ...
       <div className="below w-1/2  flex flex-col gap-5 mt-4">
        <h5>L:</h5>
        <div className='flex flex-col gap-3'>

        {['202-1965 W 4th AveVancouver, Canada','30 Chukarina StLviv, Ukraine'].map((item , index)=>(
             <a className='underline' href="">{item}</a>
        ))}
        </div>
       </div>
       ...
       <div className="below w-1/2 justo flex flex-col gap-5 mt-4">
        <h5>E:</h5>
        <div className='flex flex-col gap-3'>

        {['hello@ochi.design© ochi design 2024. L'].map((item , index)=>(
             <a className='underline' href="">{item}</a>
        ))}
        </div>
       </div>
